...
@Repository
@Mapper
public interface PurchaseReturnsSheetDao extends BaseMapper<PurchaseReturnsSheetPO> {
    /**
     * 获取最近一条进货退货单
     * @return 最近一条进货退货单
     */
     ...
     * 根据time返回销售单
     */
    List<PurchaseReturnsSheetPO> findAllSheetByTime(Date beginTime, Date endTime);

    /**
     * 查找指定销售单下具体的商品内容
     * @param sheetId
     */
    List<PurchaseReturnsSheetContentPO> findContentBySheetId(String sheetId);
}
