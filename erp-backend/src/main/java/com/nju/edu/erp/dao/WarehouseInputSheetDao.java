...
@Repository
@Mapper
public interface WarehouseInputSheetDao extends BaseMapper<WarehouseInputSheetPO> {
    /**
     * 获取最近一条入库单
     * @return 最近一条入库单
     */
...
/*    *//**
    ...
    List<WarehouseIODetailPO> getWarehouseInputDetailByTime(Date beginTime,Date endTime);
