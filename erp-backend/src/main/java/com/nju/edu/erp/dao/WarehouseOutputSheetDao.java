...
@Repository
@Mapper
public interface WarehouseOutputSheetDao extends BaseMapper<WarehouseOutputSheetPO> {
    /**
     * 获取最近一条出库单
     *
     * @return 最近一条出库单
     ...
     * @return
     */
    int updateById(WarehouseOutputSheetPO warehouseOutputSheetPO);
    ...
    List<WarehouseIODetailPO> getWarehouseOutputDetailByTime(Date beginTime, Date endTime);
}
